...
public class Cliente extends Thread {
    ...
    private Cliente(String hostname, int port) {
        try {
    ...
    public void run() {
        ...
        MulticastClient cvel;
        try {
            cvel = new MulticastClient(5557, "224.0.11.115");
            cvel.runClient();
        } catch (IOException e) {
    ...
    private Taulerr getRequest() {
        try {
            ObjectInputStream ois = new ObjectInputStream(in);
            t = (Taulerr) ois.readObject();
    ...
    public static void main(String[] args) {
        ...
        Cliente clientTcp = new Cliente(ipSrv,5558);
